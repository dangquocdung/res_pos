...
<a href="#" class="logo">
    ...
    <span class="logo-mini"><b>Hải Sài Gòn</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Hải Sài Gòn</b></span>
</a>
...
<nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <!-- <shift-counter v-if="this.$store.state.suser" ref="shiftCounter"></shift-counter> -->
